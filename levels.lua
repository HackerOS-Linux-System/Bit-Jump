-- levels.lua: Rozbudowane poziomy, z dłuższymi trasami i bossem
...
levels = {
    ...
    -- Poziom 2-5: Podobnie rozbudowane, z goal x=4000+, więcej elementów
    {
        platforms = {
            {x = 0, y = 550, width = 1000, height = 50},
    ...
    -- Poziom 3-5: Podobnie, z większym x dla goal (4000+), więcej elementów
    {
        platforms = {
            {x = 0, y = 550, width = 1000, height = 50},
            {x = 300, y = 400, width = 200, height = 20, moving = true, speed = 100, range = 200, baseX = 300},
        ...
        for _, platform in ipairs(platforms) do
            if platform.moving then
                if platform.axis == 'y' then
                    platform.y = platform.y + platform.speed * dt
                                                ...
                                                elseif enemy.type == 'boss' then
                                                    ...
                                                    if math.abs(enemy.x - enemy.baseX) > enemy.range / 2 then
                                                        ...
                                                        if enemy.shootTimer <= 0 then
                                                            enemy.shootTimer = 2
                                                            -- Strzelanie (rozbuduj dla pocisków)
                                                            createParticles(enemy.x, enemy.y, 20, {1, 0, 0})
                                                                ...
                                                                if math.abs(enemy.x - enemy.baseX) > enemy.range / 2 then
                                                                    ...
                                                                    for x = -camera.x * 0.5 % 50, 6000, 50 do
                                                                                                                                                                                        ...
                                                                                                                                                                                        if player.doubleJump then
                                                                                                                                                                                            ...
                                                                                                                                                                                            if player.shield then
                                                                                                                                                                                                ...
                                                                                                                                                                                                if gameMode == 'time_attack' then
                                                                                                                                                                                                    ...
                                                                                                                                                                                                    if gameOver then
                                                                                                                                                                                                        love.graphics.setColor(1, 0, 0)
                                                                                                                                                                                                        love.graphics.print("Game Over! Press R to Restart or Esc for Menu", 200, 300)
                                                                                                                                                                                                        elseif gameWon then
                                                                                                                                                                                                            love.graphics.setColor(0, 1, 0)
                                                                                                                                                                                                            love.graphics.print("You Win! High Score: " .. math.floor(highScore) .. "\nPress R to Restart or Esc for Menu", 200, 300)
                                                                                                                                                                                                            end
                                                                                                                                                                                                            end

-- menu.lua: Menu, level select, modes, pause

menuOptions = {"Start Game", "Level Select", "Game Modes", "Settings", "Achievements", "Exit"}
selectedMenu = 1
pauseOptions = {"Resume", "Settings", "Main Menu"}
selectedPause = 1
modeOptions = {"Normal", "Time Attack", "Endless"}
selectedMode = 1
selectedLevel = 1
...
love.graphics.print("Hacker Game", 300, 100, 0, 2, 2)
                                    ...
                                    for i, option in ipairs(pauseOptions) do
                                        if i == selectedPause then
                                            love.graphics.setColor(1, 1, 0)
                                                ...
                                                local achList = {"hacker", "data_collector", "endless_runner", "game_winner"}
                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                    elseif key == "escape" then
                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                        elseif state == 'rebind' then
                                                                                                                                                                                                                            if key ~= "escape" then
                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                settingsOptions[selectedSetting].values = {"Current: " .. key}
                                                                                                                                                                                                                                applySettings()
                                                                                                                                                                                                                                state = 'settings'
                                                                                                                                                                                                                                end
                                                                                                                                                                                                                                elseif state == 'achievements' then
                                                                                                                                                                                                                                    if key == "up" then
                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                        if selectedAchievement < 1 then selectedAchievement = 4 end
                                                                                                                                                                                                                                            elseif key == "down" then
                                                                                                                                                                                                                                                selectedAchievement = selectedAchievement + 1
                                                                                                                                                                                                                                                if selectedAchievement > 4 then selectedAchievement = 1 end
                                                                                                                                                                                                                                                    elseif key == "escape" then
                                                                                                                                                                                                                                                        state = 'menu'
                                                                                                                                                                                                                                                        selectedMenu = 1
                                                                                                                                                                                                                                                        end
